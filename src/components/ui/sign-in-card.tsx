            ...
            />
              ...
              <div className="relative bg-black/40 backdrop-blur-xl rounded-2xl p-8 border border-white/[0.05] shadow-2xl overflow-hidden">
                ...
                <div className="text-center space-y-2 mb-6">
                  ...
                  >
                    Sign in to continue to LayzoMarket
                  </motion.p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="flex items-center justify-between pt-2">
                    <div className="flex items-center space-x-2">
                      ...
                      <label htmlFor="remember-me" className="text-sm text-white/60 hover:text-white/80 transition-colors duration-200">
                        Remember me
                      </label>
                    </div>
                ...
                >
                  <button 
                    type="button"
                    onClick={() => navigate('/forgot-password')}
                    className="relative inline-block group/forgot text-white/50 hover:text-white/70 transition-colors duration-300 text-sm"
                  >
                    <span className="relative">
                      Forgot your password?
                      <span className="absolute bottom-0 left-0 w-0 h-[1px] bg-white/50 group-hover/forgot:w-full transition-all duration-300" />
                    </span>
                  </button>
                </motion.div>
              </form>
